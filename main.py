from piotr_wrzodak_16_1 import euclidean_algorithm
from piotr_wrzodak_16_2 import pow_exp
from piotr_wrzodak_16_3 import task3
from piotr_wrzodak_16_4 import task4
from piotr_wrzodak_16_5 import task5
